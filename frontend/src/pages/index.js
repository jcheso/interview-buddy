        ...
        <div class="flex flex-wrap -m-4">
          <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
            <div class="h-full text-center">
              ...
              <p class="leading-relaxed">
                Even my sigma grindset couldn't help get me through the grind of
                behaviour interview prep. When I found Interview Buddy I was
                able to practice daily until I was confident to land a role as
                the next CEO of Meta.
              </p>
          ...
          <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
            <div class="h-full text-center">
              ...
              />
              <p class="leading-relaxed">
                Even though I worked in finance, I hadn't quite mastered the art
                of bullshit on the spot. Interview Buddy changed everything for
                me, now I'm running the largest NFT trading platform in London.
              </p>
              <span class="inline-block h-1 w-10 rounded bg-yellow-500 mt-6 mb-4"></span>
              <h2 class="text-white font-medium title-font tracking-wider text-sm">
                GEN HALL
          ...
          <div class="lg:w-1/3 lg:mb-0 p-4">
            <div class="h-full text-center">
              ...
              <p class="leading-relaxed">
                ...
                Final Fantasy over the Christmas break and actually focus on my
                career! After two weeks of practice I was ready to chase my goal
                as a Quant on Wall Street.
              </p>
              <span class="inline-block h-1 w-10 rounded bg-yellow-500 mt-6 mb-4"></span>
              <h2 class="text-white font-medium title-font tracking-wider text-sm">
                Jack Leyland
